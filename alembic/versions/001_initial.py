...
def upgrade() -> None:
    ...
    # Each enum is used by exactly one table, so inline create_type=True (default) is safe.
    # No separate DO $$ blocks needed — SQLAlchemy creates the type when the table is created.
    ...
    op.create_table(
        ...
        sa.Column("role", sa.Enum("admin", "agent", "customer", name="userrole"), nullable=False, server_default="customer"),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("active", "closed", "archived", name="conversationstatus"), nullable=False, server_default="active"),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("pending", "approved", "rejected", "completed", name="escalationstatus"), nullable=False, server_default="pending"),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.dialects.postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("conversation_id", sa.dialects.postgresql.UUID(as_uuid=True), sa.ForeignKey("conversations.id"), nullable=False),
        sa.Column("agent_type", sa.Enum("router", "faq", "ticket", "escalation", "chitchat", "formatter", name="agenttype"), nullable=False),
        sa.Column("input_data", sa.dialects.postgresql.JSONB, nullable=False),
        sa.Column("output_data", sa.dialects.postgresql.JSONB),
        sa.Column("duration_ms", sa.Integer),
        sa.Column("status", sa.Enum("started", "completed", "failed", name="agentrunstatus"), nullable=False, server_default="started"),
